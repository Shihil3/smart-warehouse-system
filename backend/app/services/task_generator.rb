  ...
  sequence.each do |item|
    ...
    conn.exec_params(
      "INSERT INTO tasks
       ...
       VALUES ($1,$2,$3,$4,$5,$6)",
      [pallet_id, pallet["outbound_truck_id"], order, "pending", source_location, destination_location]
    )
  end
end
...
def generate_storage_task(pallet_id, staging_location_id, rack_location_id)
  ...
  conn.exec_params(
    ...
    [pallet_id, max_seq + 1, staging_location_id, rack_location_id]
  )
end
...
def generate_retrieval_task(pallet_id, truck_id, rack_location_id, dock_location_id)
  ...
  conn.exec_params(
    ...
    [pallet_id, truck_id, max_seq + 1, rack_location_id, dock_location_id]
  )
end
